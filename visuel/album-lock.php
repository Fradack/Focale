...
<style>
  :root {
    ...
    --clay: #7A4B33;
    --line: #C9C2B4;
    --line-on-scrim: rgba(231, 227, 220, 0.4);
    --danger: #A3402E;
  }
  ...
  * { box-sizing: border-box; }
  ...
  .backdrop {
    ...
    background-image:
      linear-gradient(160deg, rgba(36,33,28,0.65), rgba(20,18,15,0.75)),
      url('https://picsum.photos/id/1043/1600/1200');
  ...
  input[type="password"] {
    ...
    border: 1px solid var(--line-on-scrim);
    border-radius: 6px;
    color: #fff;
    font-family: 'Work Sans', sans-serif;
    font-size: 15px;
...
<div class="scene">
  ...
  <div class="gate">
    <div class="gate-content">
      ...
      <div id="prompt">
        <h1>Album protégé</h1>
        <p class="intro">« Mariage » n'est pas répertorié publiquement. Saisis le mot de passe transmis par l'artiste pour y accéder.</p>

        <form id="gate-form" novalidate>
          <label for="pwd">Mot de passe</label>
          <input type="password" id="pwd" name="pwd" placeholder="••••••••" autocomplete="off">
          <p class="error" id="pwd-error" role="alert">Saisis le mot de passe pour continuer.</p>
      ...
      <div class="success" id="success">
        <h1 style="font-size:26px;">Accès validé</h1>
        <p class="intro" style="margin-bottom:0;">Ceci est une démonstration de mise en page — aucune vérification réelle n'est effectuée ici.</p>
      </div>
    </div>
  </div>
